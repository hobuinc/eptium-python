...
# -*- coding: utf-8 -*-
#
# eptium documentation build configuration file
#
...
_version_py = os.path.join(repo, 'eptium', '_version.py')
version_ns = {}
...
latex_documents = [
    (master_doc, 'eptium.tex', 'eptium Documentation',
     'Ognyan Moore', 'manual'),
]
